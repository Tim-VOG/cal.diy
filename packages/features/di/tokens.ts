...
export const DI_TOKENS = {
  ...
  RESOURCE_REPOSITORY: Symbol("ResourceRepository"),
  RESOURCE_REPOSITORY_MODULE: Symbol("ResourceRepositoryModule"),
  ROOM_AVAILABILITY_SERVICE: Symbol("RoomAvailabilityService"),
  ROOM_AVAILABILITY_SERVICE_MODULE: Symbol("RoomAvailabilityServiceModule"),
  ADD_ON_REPOSITORY: Symbol("AddOnRepository"),
  ...
  NE26_BILLING_PROFILE_REPOSITORY: Symbol("Ne26BillingProfileRepository"),
  NE26_BILLING_PROFILE_REPOSITORY_MODULE: Symbol("Ne26BillingProfileRepositoryModule"),
  NE26_STAFF_REPOSITORY: Symbol("Ne26StaffRepository"),
  NE26_STAFF_REPOSITORY_MODULE: Symbol("Ne26StaffRepositoryModule"),
  NE26_ORDER_REPOSITORY: Symbol("Ne26OrderRepository"),
  NE26_ORDER_REPOSITORY_MODULE: Symbol("Ne26OrderRepositoryModule"),
  ...
  NE26_LEGAL_PAGE_REPOSITORY: Symbol("Ne26LegalPageRepository"),
  NE26_LEGAL_PAGE_REPOSITORY_MODULE: Symbol("Ne26LegalPageRepositoryModule"),
