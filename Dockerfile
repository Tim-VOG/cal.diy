...
# Pinned to the version in package.json. Unpinned, npx fetches whatever turbo
# was published last: 2.10.13 (14 Sep 2026) rejects a repeated --scope and
# broke every build the day after the previous one succeeded.
